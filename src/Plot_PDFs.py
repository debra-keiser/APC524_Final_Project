...
r2, g_r2 = extract_pdf_data(
    "../data/gr_files", "Synthetic_CSH_CSH_pdf_ramp_300_10_normalized.gr"
)
r3, g_r3 = extract_pdf_data(
    "../data/gr_files", "Synthetic_CSH_CSH_pdf_ramp_600_10_normalized.gr"
)
r4, g_r4 = extract_pdf_data(
    "../data/gr_files", "Synthetic_CSH_CSH_pdf_ramp_1000_10_normalized.gr"
)
