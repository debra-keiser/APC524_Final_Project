...
from Extract_Data import extract_pdf_data, locate_peaks, rescale_g_r
...
def plot_zoomed_peaks(r_list, g_r_list, legend_labels, filename):
    ...
    for bond_length in labels.keys():
        plt.text(bond_length[1], labels[bond_length], f"{bond_length[0]}", ha='center', va='bottom')
...
def Plot_multiple_PDFs():
    ...
    r2, g_r2 = extract_pdf_data("./data/gr_files", "Synthetic_CSH_CSH_pdf_ramp_300_09_normalized.gr")
    r3, g_r3 = extract_pdf_data("./data/gr_files", "Synthetic_CSH_CSH_pdf_ramp_600_09_normalized.gr")
    r4, g_r4 = extract_pdf_data("./data/gr_files", "Synthetic_CSH_CSH_pdf_ramp_1000_09_normalized.gr")
    ...
    return total_plot_filename, zoomed_plot_filename  # Return filenames or paths of the saved PNG files
